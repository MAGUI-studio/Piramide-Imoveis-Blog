/**
 * Seed Script Completo - 18 Artigos In-Depth com 8 a 12 Seções Cada
 * Pirâmide Imóveis Studio
 */
...
async function runSeed() {
  ...
  const posts = [
    // ==========================================
    // 🌟 OS 6 ARTIGOS EM DESTAQUE (HERO CAROUSEL)
    // ==========================================

    // 1. Destaque: Financiamento 2026 (Dica de Ouro + FAQ + CTA WhatsApp)
    {
    ...
    // 2. Destaque: Aquarius e Urbanova SJC (Vídeo + Galeria + Imagem no Texto + CTA)
    {
    ...
    // 3. Destaque: Ubatuba e Litoral Norte (Callout Atenção + FAQ + Foto no Texto)
    {
    ...
    // 4. Destaque: Campos do Jordão (Vídeo + Callout Informação + FAQ de Montanha)
    {
    ...
    // 5. Destaque: Studios e Lançamentos para Investimento (Dica + FAQ + CTA + Foto)
    {
    ...
    // 6. Destaque: Ilhabela e São Sebastião Pé na Areia (Galeria + CTA WhatsApp + Foto)
    {
    ...
    // ==========================================
    // 📄 OS 12 ARTIGOS NORMAIS (FEATURED = FALSE)
    // ==========================================

    // 7. Arquitetura Autoral (Citação + Galeria + Foto)
    {
    ...
    // 8. Documentação e Due Diligence (Atenção + FAQ Jurídico + CTA Consultoria)
    {
    ...
    // 9. Jacareí e Condomínios Fechados (Dica + FAQ Deslocamento)
    {
    ...
    // 10. Roteiro Gastronômico (Galeria + Fotos)
    {
    ...
    // 11. Casas Sustentáveis e Energia Solar (Vídeo + Informação + FAQ)
    {
    ...
    // 12. Vila Ema e Jardim Esplanada (Callout Informação + Foto no Texto)
    {
    ...
    // 13. Decoração e Ambientes Integrados (Galeria de Ambientes + Foto)
    {
    ...
    // 14. Custos Extras na Compra: ITBI, Escritura e Registro (Atenção + FAQ de Taxas)
    {
    ...
    // 15. Caraguatatuba e Contornos da Tamoios (Informação + CTA Lançamentos)
    {
    ...
    // 16. Lei do Inquilinato: Locação Segura (Atenção + FAQ de Locação)
    {
    ...
    // 17. Taubaté e Quiririm (Dica de Bairro + Foto no Texto)
    {
    ...
    // 18. Reforma Inteligente e Valorização (Dica de Ouro + Galeria + CTA Avaliação)
    {
      ...
      body: buildBody(
        ...
        [
          ...
          {
            title: "2. Pintura Neutra com Cores Claras para Maximizar a Luz",
            paragraphs: [
